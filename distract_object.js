...
//Установим связь отдельного экземпляра с пртотипом.
//Устаревшая запись:
//john.__proto__ = soldier;
//вместо john.__proto__ = soldier нужно использовать

Object.setPrototypeOf(john, soldier); // в случаи если john уже создан, так устанавливается связь
//но правильно сразу создавть новый объект используя портотип

const bob = Object.create(soldier);
console.log(bob.arm);  // у jhon есть свойства soldier
bob.sayHello();  

console.log(john.arm);  // у jhon есть свойства soldier
john.sayHello();  
